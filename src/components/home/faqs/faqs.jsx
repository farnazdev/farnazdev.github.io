...
const SkillsList = () => {
  ...
  const skills = {
    "What technologies do I use?": [
      "I currently work with technologies such as PHP, Python, Flutter, Dart, JavaScript, and various IoT frameworks. I specialize in backend development, Telegram bot programming, smart home systems, and mobile application development.",
    ],
    "My Experience": [
      "I have experience working in both corporate and freelance environments. I've worked on diverse projects including CRM development, IoT systems, Telegram bots, mobile applications, and web-based management systems. My work spans from educational institutions to technology companies.",
    ],
    "My Education": [
